...
test_that("webscrape_icd() function works!", {
  icd10_2022 <- webscrape_icd(icd_version = "ICD10", quiet = TRUE)
  ...
  expect_s3_class(icd10_2022, "data.frame")
  ...
  expect_error( webscrape_icd("ICD10", 2023, quiet = TRUE), "cannot be in the future")
})
