...
#' Rnssp package. Please run the `Rnssp_vignettes()` function to browse all available vignettes.
#'
...
#' To list all available template, run the `list_templates()` function. Please, check
