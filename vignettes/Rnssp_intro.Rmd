...
# Introduction {-}
The goal of `Rnssp` package is to facilitate the access to the `ESSENCE` system via a secure and simplified interface. In addition, `Rnssp` provides methods and functions that streamline the data pull by abstracting the complexity of the R codes from the users.
